...
def click_and_draw(event, x, y, flags, param):
    global refPt, imagen, FlagEND, time, thresh

    '''
    Debes pulsar con el botón izquierdo para empezar, con el botón derecho para añadir un punto y 
    con doble click izquierdo para cerrar la región
    '''
